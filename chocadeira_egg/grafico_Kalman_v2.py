...
# Valores típicos de sintonia com base nos parâmetros estatísticos reais 
# (σ_bruto=7.351 -> σ_Kalman=7.496)
...
# 2. CONFIGURAÇÃO DA PLOTAGEM (Gráfico C v2)
plt.figure(figsize=(7, 4), dpi=300)

# Sinal bruto (VERMELHO para alto contraste) - alteração solicitada
plt.plot(df['Tempo'], df['DHT22_bruto'], label='DHT22 bruto', 
         color='red', alpha=0.9, linewidth=1)

# Sinal filtrado por Kalman (azul escuro) - mantido
...
# Salva o arquivo na pasta com nome diferenciado
plt.savefig('grafico_C_Kalman_v2.png', dpi=300)
print("Sucesso! O arquivo 'grafico_C_Kalman_v2.png' foi gerado com sucesso.")
plt.close()